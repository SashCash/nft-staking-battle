...
export interface SamuraiNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  decodeFunctionResult(functionFragment: "openMint", data: BytesLike): Result;
...
export interface SamuraiNFT extends BaseContract {
  connect(runner?: ContractRunner | null): SamuraiNFT;
  waitForDeployment(): Promise<this>;

  interface: SamuraiNFTInterface;
  ...
  openMint: TypedContractMethod<[to: AddressLike], [void], "nonpayable">;
