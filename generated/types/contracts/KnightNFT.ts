...
export interface KnightNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface KnightNFT extends BaseContract {
  connect(runner?: ContractRunner | null): KnightNFT;
  waitForDeployment(): Promise<this>;

  interface: KnightNFTInterface;
